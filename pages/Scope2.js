import { Text, View, Picker, TextInput, TouchableOpacity, StyleSheet, ScrollView } from "react-native";
...
export const Scope2 = () => {
    ...
    const colors = ["#5E2BFF", "#C04CFD", "#FC6DAB", "#65524D"]
...
You can see on the left 4 boxes. 
...
Gas: For natural gas consumption, you can find the relevant information on your gas bill. Look for a section that provides details on your gas usage. Gas usage is typically measured in units like therms or cubic feet.
    ...
    return (
        <View style={{
            ...
            {
                showChatbot && <View style={{ position: "absolute", width: '50vw', top: 0, right: 0, zIndex: 1 }}>
                    <SearchArea chat={chat} setChat={setChat} setShow={setShowChatbot} firstMess={messDisplayed[indexMess]} messColor={["green", ...colors][indexMess]} />
                </View>
            }
            {
            ...
            <View>
                {
                    <View style={styles.boxEmission}>
                        ...
                        <ScrollView horizontal onContentSizeChange={() => scrollRef.current.scrollToEnd({ animated: true })} ref={scrollRef} style={{ flexDirection: "row", paddingLeft: graph[steps[0]].length && 10, paddingBottom: graph[steps[0]].length && 10, paddingRight: graph[steps[0]].length && 10 }}>
                            {
                ...
                }
                {
                    <View style={styles.boxEmission}>
                        ...
                        <ScrollView horizontal onContentSizeChange={() => scrollRef2.current.scrollToEnd({ animated: true })} ref={scrollRef2} style={{ flexDirection: "row", paddingLeft: graph[steps[1]].length && 10, paddingBottom: graph[steps[1]].length && 10, paddingRight: graph[steps[1]].length && 10 }}>
                            {
                ...
                }
                {
                    ...
                    <View style={styles.boxEmission}>
                        ...
                        <ScrollView horizontal onContentSizeChange={() => scrollRef3.current.scrollToEnd({ animated: true })} ref={scrollRef3} style={{ flexDirection: "row", paddingLeft: graph[steps[2]].length && 10, paddingBottom: graph[steps[2]].length && 10, paddingRight: graph[steps[2]].length && 10 }}>
                            {
                ...
                }
                {
                    ...
                    <View style={styles.boxEmission}>
                        ...
                        <ScrollView horizontal onContentSizeChange={() => scrollRef4.current.scrollToEnd({ animated: true })} ref={scrollRef4} style={{ flexDirection: "row", paddingLeft: graph[steps[3]].length && 10, paddingBottom: graph[steps[3]].length && 10, paddingRight: graph[steps[3]].length && 10 }}>
                            {
